...
<html>
    ...
    <body>
        ...
        <h2 class="username">Username: ${a.username}</h2>
        <a href="addproduct" class="userCRUD addNewProduct" style="text-decoration: none">Add new product</a><br/>
        <c:if test="${requestScope.data.size() == 0}">
            <div style="margin: 20px 0 20px 10%; height: 50vh;">There is no product in your shop</div>
        </c:if>
        <c:if test="${requestScope.data.size() != 0}">        
            <div class="table-container"><table class="table table-hover table-bordered caption-top table-responsive" style="margin: 0 auto; width: 80%">
                    ...
                    <tbody>
                        <c:forEach items="${requestScope.data}" var="i">
                            <tr>
                                ...
                                <td>${i.brand}</td>
                                <td><a href="updateproduct?productid=${i.productID}" class="userCRUD">Update</a>&nbsp;&nbsp;&nbsp;&nbsp;<a class="userCRUD" onclick="deleteProduct('${i.productID}')">Delete</a></td>
                            </tr>
                        </c:forEach>
                    </tbody>
