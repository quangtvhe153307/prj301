        ...
        <div>
            <form action="sellerregister" method="post">
                <div class="profile-infor-container">
                    ...
                    <div class="profile-fields"><strong>Shop Name:</strong><input type="text" name="shopname" value="${requestScope.shop.shopName}"/></div>
                    <div class="shop-des"><strong>Describe: </strong><textarea style="width: 500px; height: 200px;" name="describe">${requestScope.shop.des}</textarea></div>
                    <div><input class="register-button" type="submit" value="Register" <c:if test="${requestScope.message != null }">disable</c:if> /> <span style="color: #D10024;margin-left: 10px; font-size: 20px; font-weight: 500;">${requestScope.message}</span></div>
