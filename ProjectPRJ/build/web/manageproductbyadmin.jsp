        ...
        <div class="container-fluid">
            <div class="row">
                <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                    <div class="sidebar-sticky pt-3">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="productmanageadmin">
                ...
                <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4" style="background: rgba(0,0,0,.05); padding-top: 50px;">
                    <a href="addproductadmin" class="userCRUD addNewProduct" style="text-decoration: none; margin-left: 10%;">Add new product</a><br/>
                    ...
                    <c:if test="${requestScope.data.size() != 0}">        
                        <div class="table-container"><table class="table table-hover table-bordered caption-top table-responsive bg-light" style="margin: 0 auto; width: 80%">
                                ...
                                <thead><tr><th class="col">ProductName</th>
                                        <th class="col">CategoryID</th>
                                        <th class="col">UnitsPrice</th>
                                        <th class="col">UnitsInStock</th>
                                ...
                                <tbody>
                                    <c:forEach items="${requestScope.data}" var="i">
                                        <tr>
                                            <td>${i.name}</td>
                                            <td>${i.categoryID}</td>
                                            <td><fmt:formatNumber type="currency" currencySymbol="đ">${i.price}</fmt:formatNumber></td>
                                            <td>${i.unitsInStock}</td>
                                            <td><img src="${i.image}" style="width: 80px; height: 80px;"></td>
                                            <td>${i.brand}</td>
                                            <td><a href="updateproductadmin?productid=${i.productID}" class="userCRUD" style="text-decoration: none">Update</a>&nbsp;&nbsp;&nbsp;&nbsp;<a style="text-decoration: none;" class="userCRUD" onclick="deleteProduct('${i.productID}')">Delete</a></td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
                        ...
                        <nav aria-label="Page navigation example">
                            <ul class="pagination">
                                <li class="page-item <c:if test="${page == 1}">disabled</c:if>">
                                    <a class="page-link bg-light" href="productmanageadmin?page=${page-1}" aria-label="Previous">
                                        <span aria-hidden="true">&laquo;</span>
                                    </a>
                                </li>
                                <c:forEach begin="${1}" end="${requestScope.number}" var="i">

                                    <li class="page-item"><a class="page-link bg-light" href="productmanageadmin?page=${i}">${i}</a></li>
                                    </c:forEach>
                                <li class="page-item <c:if test="${page == requestScope.number}">disabled</c:if>">
                                    <a class="page-link bg-light" href="productmanageadmin?page=${page+1}" aria-label="Next">
