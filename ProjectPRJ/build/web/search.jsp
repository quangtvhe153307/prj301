<%-- 
    Document   : search
    Created on : Mar 3, 2022, 10:55:51 PM
    Author     : Admin
--%>
...
<html>
    ...
    <body style="background: rgba(0,0,0,.03);">
        ...
        <c:set var="b" value="${requestScope.cateList}"/>   
        ...
        <div class="main-content-search">
            <div class="left">
                ...
                <form id="form1">
                    <div class="filter-group brand-filter">
                        ...
                        <div class="folding-items">
                            <c:forEach begin="0" end="${b.size()-1}" var="i">
                                <div class="check-brand-container"><input type="checkbox" class="checkCategory" value="${b.get(i).catID}" name="categoryFilter" <c:if test="${c1[i]}">checked</c:if> /><span>${b.get(i).catName}</span><br/></div>
                    ...
                    <div class="filter-group price-range-filter" style="margin-top: 20px;">
                ...
                <button onclick="submitFormsSearchProduct()" class="left-search-button">Submit</button>
            </div>
            <div class="right container">
                <div class="sort-bar">
                    ...
                    <div class="sort-option">
                        <form id="form2">
                            <select name="sortBy" id="sortOption" onchange="submitFormsSearchProduct()()">
                    ...
                    <div class="minipage-controller">
                        ...
                        <button class="previous" <c:if test="${requestScope.page == 1}">disabled</c:if> onclick="submitFormsSearchProductPreviousPage()()"><i class="fa-solid fa-angle-left"></i></button>
                        <button class="next" <c:if test="${requestScope.page == requestScope.num}">disabled</c:if> onclick="submitFormsSearchProductNextPage()()"><i class="fa-solid fa-angle-right"></i></button>
                        </div>
                    </div>
