        ...
        <div>
            <form action="userprofile" method="post">
                <div class="profile-infor-container">
                    ...
                    <div class="profile-fields"><strong>Contact Name</strong><input type="text" name="contact" value="${a.contactName}" required/></div>
                    <div class="profile-fields"><strong>Address:</strong> <input type="text" name="address" value="${a.address}" style="width: 400px;" required/></div>
                    <div class="profile-fields"><strong>City:</strong> <input type="text" name="city" value="${a.city}" style="width: 100px;" required/></div>
                    <div class="profile-fields"><strong>Phone:</strong> <input type="tel" name="phone" value="${a.phone}" style="width: 150px;" required/></div>
                    <div class="profile-fields"><strong>Email:</strong> <input type="email" name="email" value="${a.email}" required/></div>
