        ...
        <div class="container-fluid">
            <div class="row">
                <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                    <div class="sidebar-sticky pt-3">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="accountmanageadmin">
                ...
                <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4" style="background: rgba(0,0,0,.05); padding-top: 50px;">
                    <a href="addaccountadmin" class="userCRUD addNewProduct" style="text-decoration: none; margin-left: 10%;">Add new account</a><br/>
                    <c:if test="${requestScope.data.size() == 0}">
                        <div style="margin: 20px 0 20px 10%; height: 50vh;">There is no account in your shop</div>
                    </c:if>
                    <c:if test="${requestScope.data.size() != 0}">        
                        ...
                        <nav aria-label="Page navigation example">
                            <ul class="pagination">
                                <li class="page-item <c:if test="${page == 1}">disabled</c:if> bg-light">
                                    <a class="page-link bg-light" href="accountmanageadmin?page=${page-1}" aria-label="Previous">
                                        <span aria-hidden="true">&laquo;</span>
                                    </a>
                                </li>
                                <c:forEach begin="${1}" end="${requestScope.number}" var="i">

                                    <li class="page-item bg-light"><a class="page-link bg-light" href="accountmanageadmin?page=${i}">${i}</a></li>
                                    </c:forEach>
                                <li class="page-item bg-light <c:if test="${page == requestScope.number}">disabled</c:if>">
                                    <a class="page-link bg-light" href="accountmanageadmin?page=${page+1}" aria-label="Next">
