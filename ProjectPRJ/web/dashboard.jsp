                    ...
                    <div class="flex flex-column">
                        <div class="main-dashboard-row">
                            <div class="infor-container">
                                <span style="color: red;"><i class="fa-solid fa-store"></i></span>
                                <div>Total sellers: </div>
                                <div>${requestScope.shop}</div>
                            </div>
                            <div class="infor-container">
                                <span style="color: blue;"><i class="fa-solid fa-shirt"></i></span>
                                <div>Total products:</div>
                                <div>${requestScope.product}</div>
                            </div>
                        ...
                        <div class="main-dashboard-row">
                            <div class="infor-container">
                                <span style="color: yellow;"><i class="fa-solid fa-comment"></i></span>
                                <div>Total feedbacks:</div>
                                <div>${requestScope.feedback}</div>
                            </div>
                            <div class="infor-container">
                                <span style="color: green;"><i class="fa-solid fa-heart"></i></span>
                                <div>Total sales:</div>
                                <div><fmt:formatNumber type="currency" value="${requestScope.sale}" currencySymbol="d" /></div>
                            </div>
                        ...
                        <div class="main-dashboard-row">
                            <div class="infor-container">
                                <span style="color: purple;"><i class="fa-solid fa-shirt"></i></span>
                                <div>Total orders:</div>
                                <div>${requestScope.order}</div>
                            </div>
                            <div class="infor-container">
                                <span style="color: lightblue;"><i class="fa-solid fa-user"></i></span>
                                <div>Total user:</div>
